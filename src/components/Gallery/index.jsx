...
const Gallery = () => {
  ...
  return (
    <section className="section-gallery" ref={ref}>
      ...
      <div className="list">
        <img data-flickity-lazyload="./img/img_team1.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team2.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team3.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team4.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team3.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team4.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team1.png" alt="img" />
        <img data-flickity-lazyload="./img/img_team2.png" alt="img" />
